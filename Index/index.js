let image=document.getElementById('imag-pop');
let imagges=['get1.jpg','get2.jpg','pp3.jpg','index page.png','pw1.jpg']
setInterval(function(){
    let random=Math.floor(Math.random()*4)
    image.src=imagges[random]
},800);


var typed=new Typed(".auto-type",{
    strings: ["Parking Camera","Parking Equipment","Parking Transaction","Parking gate"],
    typeSpeed: 150,
    backSpeed: 150,
    loop: true
})

var typedw=new Typed(".auto-type2",{
    strings:["Mobile App","Interface","Revenue Dashboard","Timely Support"],
    typeSpeed:150,
    backSpeed:150,
    loop:true
})

var typed=new Typed(".auto-t",{
    strings: ["Solution","One Place","Sensetion"],
    typeSpeed: 150,
    backSpeed: 150,
    loop: true
})
